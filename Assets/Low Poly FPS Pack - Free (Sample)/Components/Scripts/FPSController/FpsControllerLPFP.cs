...
#pragma warning restore 649
        ...
        private static float ClampRotationRestriction(float rotationRestriction, float min, float max)
        {
            ...
            var message = $"Rotation restrictions should be between {min} and {max} degrees.";
        ...
        private class SmoothRotation
        {
            ...
            public float Update(float target, float smoothTime) => _current = Mathf.SmoothDampAngle(_current, target, ref _currentVelocity, smoothTime);
        ...
        private class SmoothVelocity
        {
            ...
            public float Update(float target, float smoothTime) => _current = Mathf.SmoothDamp(_current, target, ref _currentVelocity, smoothTime);
